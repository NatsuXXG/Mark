    ...
    <scroll class="scroll-wrap" v-show="conIndex === 0" ref="scroll" :data="pingteweishuNumBalls">
      <div class="tm-a-wrap clearfix">
        <div class="tm-a-top clearfix">
          <div class="numball-wrap" v-for="(ball, index) in pingteweishuNumBalls" :class="{'ballChoosing':ball.bool}" :key="index" @click="selectBallnums(ball, index, $event, tabItems[conIndex], submitType, pingteweishugID, pingteweishuNumBalls)" ref="pingteweishu">
