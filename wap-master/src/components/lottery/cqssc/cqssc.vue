<template>
  <div class="ssc-wrapper" ref="sccwrapper">
    <lottery-wrapper  :lotterytype="lotterytype" :records="records"
                      ...
                      :ballnums="ballnums" :posturl="posturl" :inputname="inputname" :lotteryBallJudge="lotteryBallJudge" :lotteryLHH="lotteryLHH" :showniuniu="showniuniu" :getRecords="_getRecords" :getHistoryRecords="_getHistoryRecords"
    ></lottery-wrapper>
  </div>
</template>
