                ...
                <div class="one-common-wrap">
                  ...
                  <div class="team-odd-wrap">
                    <div class="team-odd-row">
                      <span class="click-hook" @click="submitOrder(sport,sport.Match_Total01Pl,'','入球数:0-1', 'Match_Total01Pl')">{{sport.Match_Total01Pl}}</span>
                      <span class="click-hook" @click="submitOrder(sport,sport.Match_Total23Pl,'','入球数:2-3', 'Match_Total23Pl')">{{sport.Match_Total23Pl}}</span>
                      <span class="click-hook" @click="submitOrder(sport,sport.Match_Total46Pl,'','入球数:4-6', 'Match_Total46Pl')">{{sport.Match_Total46Pl}}</span>
                      <span class="click-hook" @click="submitOrder(sport,sport.Match_Total7upPl,'','入球数:7up', 'Match_Total7upPl')">{{sport.Match_Total7upPl}}</span>
                    </div>
                  </div>
                </div>
              </div>
