...
<div>
                ...
                <div class="info-content-wrap">
                  ...
                  <div class="type-h-wrap" v-if="!sport.sbbool_1">
                    ...
                    <div class="type-h-right">
                      ...
                      <p class="type-h-odd">
                        <strong class="type-name">客</strong>
                        <span class="onlywin" :class="{'click-hook': sport.Match_Bgdy1 > 0}" @click="submitOrder(sport,sport.Match_Bgdy1,sport.Match_Guest,'上半场-独赢','Match_Bgdy')">{{sport.Match_Bgdy1>0?sport.Match_Bgdy1:''}}</span>
                        <span class="pankou-wrap">
                      ...
                      <div class="type-h-odd">
                        <strong class="type-he">和局</strong>
                        <p class="he-odd" :class="{'click-hook': sport.Match_Bhdy1 > 0}" @click="submitOrder(sport,sport.Match_Bhdy1,'和局','上半场-独赢','Match_Bhdy')">{{sport.Match_Bhdy1>0?sport.Match_Bhdy1:''}}</p>
                      </div>
                    </div>
                  </div>
                </div>
  ...
  <!-- 当加载赛事组数据比较缓慢的时候，为了优化用户的感官体验效果，需要实现等到load的一个过程-->
