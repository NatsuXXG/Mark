<template>
  <div>
    <div class="sport-main-wrap">
      <scroll class="scroll-wrap" :data="sportDatas" :pulldown="true" @pulldown="loadTop" :pullup="true" @pullup="loadBottom" ref="scroll">
        <div class="item-wrap" style="min-height:80vh" v-show="sportDatas && sportDatas.length > 0">
          <div class="top-tip">
            ...
            <div class="item-content-wrap" v-show="item.bool">
              <div class="item-content" v-for="(sport, sindex) in item.sports" :key="sindex" :class="{'itemBg': index % 2 === 0}">
                <div class="sport-time">
                  <p class="no-hook"></p>
                  <p class="stime">
                    <span>{{sport.Match_Time}}</span>
                  </p>
                  <p class="stype">
                    滚球<img src="../../../assets/ballroll.png" alt="" class="ballroll">
                  </p>
                </div>
                      ...
                      <div class="type-h-right">
                        <p class="type-h-odd">
                          ...
                          <span class="pankou-wrap">
                            ...
                            <span class="h-ho" :class="{'click-hook': sport.Match_Ho > 0}" @click="submitOrder(sport,sport.Match_Ho,sport.Match_Master,'全场-让分', 'Match_Ho')">{{sport.Match_Ho>0 ? sport.Match_Ho : ''}}</span>
                          </span>
                          <span class="dx-wrap">
                        ...
                        <p class="type-h-odd">
                          ...
                          <span class="pankou-wrap">
                            ...
                            <span class="h-ho" :class="{'click-hook': sport.Match_Ao > 0}" @click="submitOrder(sport,sport.Match_Ao,sport.Match_Guest,'全场-让分', 'Match_Ao')">{{sport.Match_Ao>0?sport.Match_Ao:''}}</span>
                          </span>
                          <span class="dx-wrap">
    ...
    <sport-submit :ifsubmitShow="ifsubmitShow" :sports="sports" :sportOdd="sportOdd" :typename="typename" :currentTeam="currentTeam" :ballsort="ballsort" :oddName="oddName" :typetitle="typetitle" :getsportDatas="_getsportDatas" @toggleIfSubmit="toggleIfSubmit"></sport-submit>
